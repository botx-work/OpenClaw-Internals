...
- [src/config/config.schema-regressions.test.ts](file://src/config/config.schema-regressions.test.ts)
- [src/config/config.plugin-validation.test.ts](file://src/config/config.plugin-validation.test.ts)
- [src/agents/workspace.bootstrap-cache.test.ts](file://src/agents/workspace.bootstrap-cache.test.ts)
- [extensions/open-prose/skills/prose/state/filesystem.md](file://extensions/open-prose/skills/prose/state/filesystem.md)
