...
- [config.ts](file://extensions/matrix/src/matrix/client/config.ts)
- [config-schema.ts](file://extensions/matrix/src/config-schema.ts)
- [room.ts](file://extensions/matrix/src/matrix/actions/room.ts)
- [events.ts](file://extensions/matrix/src/matrix/monitor/events.ts)
- [deps.ts](file://extensions/matrix/src/matrix/deps.ts)
- [allowlist.ts](file://extensions/matrix/src/matrix/monitor/allowlist.ts)
- [room-info.ts](file://extensions/matrix/src/matrix/monitor/room-info.ts)
- [auto-join.ts](file://extensions/matrix/src/matrix/monitor/auto-join.ts)
</cite>
