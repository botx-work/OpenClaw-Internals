...
- [src/shared/chat-message-content.ts](file://src/shared/chat-message-content.ts)
- [src/sessions/session-id.ts](file://src/sessions/session-id.ts)
- [src/shared/entry-metadata.ts](file://src/shared/entry-metadata.ts)
- [src/types/extension-api.d.ts](file://src/types/extension-api.d.ts)
- [dist/plugin-sdk/agents/auth-profiles/profiles.d.ts](file://dist/plugin-sdk/agents/auth-profiles/profiles.d.ts)
- [dist/plugin-sdk/agents/auth-profiles/store.d.ts](file://dist/plugin-sdk/agents/auth-profiles/store.d.ts)
...
- [src/channels/reply-prefix.ts](file://src/channels/reply-prefix.ts)
...
- [src/plugins/types.js](file://src/plugins/types.js)
- [src/plugins/runtime/types.js](file://src/plugins/runtime/types.js)
...
- [src/security/dm-policy-shared.js](file://src/security/dm-policy-shared.js)
- [src/hooks/types.js](file://src/hooks/types.js)
...
- [src/terminal/ansi.js](file://src/terminal/ansi.js)
- [src/infra/outbound/target-errors.js](file://src/infra/outbound/target-errors.js)
- [src/infra/net/ssrf.js](file://src/infra/net/ssrf.js)
- [src/infra/net/fetch-guard.js](file://src/infra/net/fetch-guard.js)
- [src/infra/net/ip.ts](file://src/infra/net/ip.ts)
- [src/infra/net/ipv4.ts](file://src/infra/net/ipv4.ts)
...
- [src/infra/dedupe.js](file://src/infra/dedupe.js)
...
- [src/plugin-sdk/resolution-notes.js](file://src/plugin-sdk/resolution-notes.js)
...
- [src/plugin-sdk/webhook-path.js](file://src/plugin-sdk/webhook-path.js)
...
- [src/plugin-sdk/allow-from.js](file://src/plugin-sdk/allow-from.js)
...
- [src/plugin-sdk/config-paths.js](file://src/plugin-sdk/config-paths.js)
- [src/plugin-sdk/text-chunking.js](file://src/plugin-sdk/text-chunking.js)
- [src/plugin-sdk/boolean-param.js](file://src/plugin-sdk/boolean-param.js)
...
- [src/plugin-sdk/run-command.js](file://src/plugin-sdk/run-command.js)
...
- [src/plugin-sdk/file-lock.js](file://src/plugin-sdk/file-lock.js)
- [src/plugin-sdk/channel-lifecycle.js](file://src/plugin-sdk/channel-lifecycle.js)
- [src/plugin-sdk/agent-media-payload.js](file://src/plugin-sdk/agent-media-payload.js)
- [src/plugin-sdk/status-helpers.js](file://src/plugin-sdk/status-helpers.js)
- [src/plugin-sdk/account-id.d.ts](file://src/types/account-id.d.ts)
- [src/plugin-sdk/agents/agent-paths.d.ts](file://src/plugin-sdk/agents/agent-paths.d.ts)
- [src/plugin-sdk/agents/agent-scope.d.ts](file://src/plugin-sdk/agents/agent-scope.d.ts)
- [src/plugin-sdk/agents/announce-idempotency.d.ts](file://src/plugin-sdk/agents/announce-idempotency.d.ts)
- [src/plugin-sdk/agents/anthropic-payload-log.d.ts](file://src/plugin-sdk/agents/anthropic-payload-log.d.ts)
- [src/plugin-sdk/agents/api-key-rotation.d.ts](file://src/plugin-sdk/agents/api-key-rotation.d.ts)
- [src/plugin-sdk/agents/apply-patch.d.ts](file://src/plugin-sdk/agents/apply-patch.d.ts)
- [src/plugin-sdk/agents/apply-patch-update.d.ts](file://src/plugin-sdk/agents/apply-patch-update.d.ts)
- [src/plugin-sdk/agents/auth-health.d.ts](file://src/plugin-sdk/agents/auth-health.d.ts)
- [src/plugin-sdk/agents/auth-profiles/constants.d.ts](file://src/plugin-sdk/agents/auth-profiles/constants.d.ts)
- [src/plugin-sdk/agents/auth-profiles/display.d.ts](file://src/plugin-sdk/agents/auth-profiles/display.d.ts)
- [src/plugin-sdk/agents/auth-profiles/doctor.d.ts](file://src/plugin-sdk/agents/auth-profiles/doctor.d.ts)
- [src/plugin-sdk/agents/auth-profiles/external-cli-sync.d.ts](file://src/plugin-sdk/agents/auth-profiles/external-cli-sync.d.ts)
- [src/plugin-sdk/agents/auth-profiles/oauth.d.ts](file://src/plugin-sdk/agents/auth-profiles/oauth.d.ts)
- [src/plugin-sdk/agents/auth-profiles/order.d.ts](file://src/plugin-sdk/agents/auth-profiles/order.d.ts)
- [src/plugin-sdk/agents/auth-profiles/paths.d.ts](file://src/plugin-sdk/agents/auth-profiles/paths.d.ts)
- [src/plugin-sdk/agents/auth-profiles/profiles.d.ts](file://src/plugin-sdk/agents/auth-profiles/profiles.d.ts)
- [src/plugin-sdk/agents/auth-profiles/repair.d.ts](file://src/plugin-sdk/agents/auth-profiles/repair.d.ts)
- [src/plugin-sdk/agents/auth-profiles/session-override.d.ts](file://src/plugin-sdk/agents/auth-profiles/session-override.d.ts)
- [src/plugin-sdk/agents/auth-profiles/store.d.ts](file://src/plugin-sdk/agents/auth-profiles/store.d.ts)
</cite>
