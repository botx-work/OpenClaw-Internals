...
<cite>
**本文引用的文件**
- [src/cli/browser-cli-actions-input.ts](file://src/cli/browser-cli-actions-input.ts)
- [src/cli/browser-cli-actions-input/register.js](file://src/cli/browser-cli-actions-input/register.js)
