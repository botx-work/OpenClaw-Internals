...
<cite>
**本文引用的文件**
- [安全文档总览](file://docs/security/README.md)
- [威胁模型与贡献指南](file://docs/security/THREAT-MODEL-ATLAS.md)
- [贡献威胁模型](file://docs/security/CONTRIBUTING-THREAT-MODEL.md)
- [网关认证与OAuth](file://docs/gateway/authentication.md)
- [可信代理认证](file://docs/gateway/trusted-proxy-auth.md)
- [安全审计报告](file://src/security/audit.ts)
- [安全审计单元测试](file://src/security/audit.test.ts)
- [TLS与证书管理](file://src/infra/tls/gateway.ts)
- [Android 网关TLS配置](file://apps/android/app/src/main/java/ai/openclaw/app/gateway/GatewayTls.kt)
- [iOS 网关TLS配置](file://apps/ios/Sources/Gateway/GatewayConnectionController.swift)
- [OAuth回调处理](file://extensions/google-gemini-cli-auth/oauth.ts)
- [HTTP通用鉴权与限流](file://src/gateway/http-common.ts)
- [网关鉴权逻辑](file://src/gateway/auth.ts)
- [安全审计命令输出](file://src/commands/status.command.ts)
- [密钥与机密管理类型定义](file://src/config/types.secrets.ts)
- [机密审计与报告](file://src/secrets/audit.ts)
- [安全基线与漏洞扫描](file://.secrets.baseline)
- [安全策略与范围](file://SECURITY.md)
</cite>
