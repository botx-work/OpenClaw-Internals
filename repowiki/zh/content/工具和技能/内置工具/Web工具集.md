...
- [firecrawl-compare.ts](file://scripts/firecrawl-compare.ts)
- [readability-basic-compare.ts](file://scripts/readability-basic-compare.ts)
- [web-fetch.ssrf.test.ts](file://src/agents/tools/web-fetch.ssrf.test.ts)
