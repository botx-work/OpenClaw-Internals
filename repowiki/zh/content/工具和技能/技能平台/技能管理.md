...
- [skills.ts](file://apps/macos/Sources/OpenClaw/SkillsSettings.swift)
- [skills-shared.ts](file://ui/src/ui/views/skills-shared.ts)
- [skills.ts](file://apps/macos/Sources/OpenClawProtocol/GatewayModels.swift)
- [skills.ts](file://apps/macos/Sources/OpenClawProtocol/GatewayModels.swift)
- [skills.ts](file://src/gateway/server-methods/skills.ts)
- [skills-install.ts](file://src/agents/skills-install.ts)
- [skills-filter.ts](file://src/agents/skills/filter.ts)
