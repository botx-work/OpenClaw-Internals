...
- [src/agents/tools/web-guarded-fetch.ts](file://src/agents/tools/web-guarded-fetch.ts)
- [src/agents/tools/web-fetch.test-harness.ts](file://src/agents/tools/web-fetch.test-harness.ts)
- [src/agents/tools/web-fetch.test-mocks.js](file://src/agents/tools/web-fetch.test-mocks.js)
- [src/agents/tools/web-fetch.cf-markdown.test.ts](file://src/agents/tools/web-fetch.cf-markdown.test.ts)
- [src/agents/tools/web-tools.fetch.test.ts](file://src/agents/tools/web-tools.fetch.test.ts)
- [scripts/firecrawl-compare.ts](file://scripts/firecrawl-compare.ts)
...
- [src/agents/tools/image-tool.helpers.ts](file://src/agents/tools/image-tool.helpers.ts)
- [src/agents/tools/media-tool-shared.js](file://src/agents/tools/media-tool-shared.js)
- [src/agents/tools/model-config.helpers.js](file://src/agents/tools/model-config.helpers.js)
- [src/agents/tools/pdf-native-providers.ts](file://src/agents/tools/pdf-native-providers.ts)
- [src/agents/tools/tool-runtime.helpers.js](file://src/agents/tools/tool-runtime.helpers.js)
- [src/agents/tools/web-shared.js](file://src/agents/tools/web-shared.js)
- [src/agents/tools/web-search-citation-redirect.js](file://src/agents/tools/web-search-citation-redirect.js)
...
- [src/commands/onboard-search.ts](file://src/commands/onboard-search.ts)
</cite>
