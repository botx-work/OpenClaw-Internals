...
- [operator-scope-compat.test.ts](file://src/shared/operator-scope-compat.test.ts)
- [method-scopes.test.ts](file://src/gateway/method-scopes.test.ts)
...
- [ConnectCommand.swift](file://apps/macos/Sources/OpenClawMacCLI/ConnectCommand.swift)
- [GatewayChannel.swift](file://apps/shared/OpenClawKit/Sources/OpenClawKit/GatewayChannel.swift)
- [command-auth.owner-default.test.ts](file://src/auto-reply/command-auth.owner-default.test.ts)
- [command-control.test.ts](file://src/auto-reply/command-control.test.ts)
- [monitor.authz.test.ts](file://extensions/mattermost/src/mattermost/monitor.authz.test.ts)
- [monitor-access.ts](file://extensions/googlechat/src/monitor-access.ts)
- [inbound-processing.ts](file://src/imessage/monitor/inbound-processing.ts)
